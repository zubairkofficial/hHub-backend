...
You will receive:
- A JSON blueprint describing the visual layout: fonts, colors, alignment, spacing, positioning, aspect ratio, and visual restrictions.
...
- composed_prompt: A fluent natural-language description of how the final poster looks. 
  Include:
  • Background color and any patterns or textures (e.g. subtle waves, gradients, solid fills).  
